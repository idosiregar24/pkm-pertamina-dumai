                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
                            ...
                            {/* UMKM — hanya Admin CSR yang memilih manual. Admin Kelompok otomatis
                                terkunci ke UMKM sendiri (dipaksa server-side, bukan cuma disembunyikan). */}
                            {isAdminCsr ? (
                                <div className="mb-4">
                                ...
                                <div className="mb-4 flex items-center gap-2 px-3.5 py-2.5 rounded-xl bg-blue-50 border border-blue-100 text-xs font-semibold text-[#005BAC]">
                                    ...
                                    Produk akan otomatis tercatat sebagai milik kelompok Anda.
                                </div>
                            )}
